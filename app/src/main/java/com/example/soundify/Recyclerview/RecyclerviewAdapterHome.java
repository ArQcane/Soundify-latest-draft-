...
public class RecyclerviewAdapterHome extends RecyclerView.Adapter<RecyclerviewAdapterHome.ViewHolderClass> {
    List<Song> list;
    Context context;
    int playListNumber;
    DBHelper dbHelper;

    public RecyclerviewAdapterHome(List<Song> list, Context context, int playListNumber) {
        this.list = list;
    ...
    public ViewHolderClass onCreateViewHolder(@NonNull @org.jetbrains.annotations.NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.signle_view_recyclerview_grid, parent, false);
        return new ViewHolderClass(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @org.jetbrains.annotations.NotNull RecyclerviewAdapterHome.ViewHolderClass holder, int position) {
